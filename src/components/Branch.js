...
const Branch = () => {
    const [selectedCity, setSelectedCity] = useState({ name: 'Headquarter', phone: '(0312) 220 55 02', address: 'Söğütözü Cd. Koç Towers No:2, Söğütözü, 06510 Çankaya/Ankara', color: '#E6983F' });
    ...
    return (
        <main>
            <h1>Branches</h1>
            <h2 className='branches-direction'>Please Choose a Branch</h2>
